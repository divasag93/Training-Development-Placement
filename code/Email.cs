...
<html lang=""en"">
  ...
  <div>
       ...
       <div style='border-top-left-radius:5px;background-color:rgb(38,166,154);color:white; width: 511px; margin-left: 224px;'>
...
<html lang=""en"">
  ...
  <div>
       ...
       <div style='border-top-left-radius:5px;background-color:rgb(38,166,154);color:white; width: 511px; margin-left: 224px;'>
          <div style=' background-color:#2d95bb;'>  <p style=' float:left;padding:10px ;font-family: roboto;font-size:large'><b>Hi : <b>"+name+@"</p>
              <p style='float:right;font-family: roboto;padding:10px; font-size:medium''>Posted on :   " + DateTime.Now.ToShortDateString() + " " + DateTime.Now.ToShortTimeString() + @" </p><br />
              <br />
              <br /><br />

          </div>          <p style='border-radius:5px; margin-left: 60px;font-size:medium;'> Name :  " + name + "<br/><br/> <b> Email Address : <b>" + email + "<br/><br/><b> Your OTP is : <b>" + stt + @"
...
<html lang=""en"">
  ...
  <div>
       ...
       <div style='border-top-left-radius:5px;background-color:rgb(38,166,154);color:white; width: 511px; margin-left: 224px;'>
          ...
          </div>          <p style='border-radius:5px; margin-left: 60px;font-size:medium;'><b> Message :<b>  " + stt + @"
...
";
            ...
            try
            {
                ...
                using (MailMessage mm = new MailMessage("agarwalsurabhi64@gmail.com", email))
                {
                    mm.Subject = "Inbox";
                    mm.Body = htmlBody;
                    mm.From = new MailAddress(email, "Together Stay Happy and Stay Connected", System.Text.Encoding.UTF8);
                    mm.IsBodyHtml = true;
