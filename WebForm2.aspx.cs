            ...
            else if (Session["user"] != null)
            {
                ...
                if (dr.HasRows)
                {
                    ...
                    while (dr.Read())
                    {
                        ...
                        GridView1.Controls.AddAt(i++, details);
                        ds = null;
                        conn.Close();
                    }
                }
                ...
                {
                    NoJobs.Text = "Sorry, as of now there is no job posting.";
                    NoJobs.ForeColor = System.Drawing.Color.Red;
                    NoJobs.Visible = true;
                }
            }
        }
